...
export class WaveformTypes {
   ...
   */
  async drawSpectrogram(ctx, width, height, duration, audioBuffer, _alignInfo = {}) {
    log.info('video', '[Spectrogram] Starting draw', { width, height, duration, hasAudioBuffer: !!audioBuffer });
