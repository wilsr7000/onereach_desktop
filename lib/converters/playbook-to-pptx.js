...
class PlaybookToPptxAgent extends BaseConverterAgent {
  ...
  _buildFrameworkSlides(pptx, title, content, framework, doFramework, keywords) {
    ...
    titleSlide.addText(title, {
      ...
      h: 1.5,
      fontSize: 36,
      color: PILLAR_COLORS.title.text,
      bold: true,
      align: 'left',
    });
    if (keywords.length > 0) {
      titleSlide.addText(keywords.join(' | '), {
        ...
        h: 0.6,
        fontSize: 14,
        color: PILLAR_COLORS.title.accent,
        italic: true,
      });
    }
    ...
    if (framework.who) {
      ...
      if (whoDetails) {
        whoSlide.addText(whoDetails, {
          ...
          h: 2,
          fontSize: 16,
          color: PILLAR_COLORS.who.accent,
    ...
    if (framework.why) {
      ...
      if (whyDetails) {
        whySlide.addText(whyDetails, {
          ...
          h: 2,
          fontSize: 16,
          color: PILLAR_COLORS.why.accent,
          lineSpacingMultiple: 1.5,
        });
      }
    }
    ...
    if (framework.what) {
      ...
      if (whatDetails) {
        whatSlide.addText(whatDetails, {
          ...
          h: 2,
          fontSize: 16,
          color: PILLAR_COLORS.what.accent,
          lineSpacingMultiple: 1.5,
        });
      }
    }
    ...
    if (framework.where) {
      ...
      whereSlide.addText(framework.where.platform || 'N/A', {
        ...
        h: 1,
        fontSize: 24,
        color: PILLAR_COLORS.where.text,
      });
      const whereDetails = [
      ...
      if (whereDetails) {
        whereSlide.addText(whereDetails, {
          ...
          h: 2,
          fontSize: 16,
          color: PILLAR_COLORS.where.accent,
          lineSpacingMultiple: 1.5,
        });
      }
    }
    ...
    summarySlide.addText('Content Summary', {
      ...
      w: 8,
      fontSize: 28,
      color: PILLAR_COLORS.summary.text,
      bold: true,
    });
    ...
    summarySlide.addText(truncContent, {
      ...
      h: 4,
      fontSize: 14,
      color: PILLAR_COLORS.summary.accent,
