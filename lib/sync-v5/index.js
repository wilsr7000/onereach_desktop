 ...
 *
 * Phase 3 still excludes: pull engine (Phase 4 with snapshots),
 * snapshots / audit-log retention compaction (Phase 4), schema migration
 * tooling (Phase 5). The existing spaces-sync-manager is untouched.
 *
 ...
 * to avoid collisions; Phase 1/2 exports stay flat for backward compat
 * with tests written against the original API.
 */
