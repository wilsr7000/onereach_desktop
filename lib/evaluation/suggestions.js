...
class SuggestionManager {
  ...
  getForEvaluation(evaluationId) {
    return [...this.suggestions.values()].filter((s) => s.evaluationId === evaluationId);
  }
  ...
  getStats(evaluationId) {
    const suggestions = evaluationId ? this.getForEvaluation(evaluationId) : [...this.suggestions.values()];
