...
<div class="app">
  ...
  <div class="session-view" id="sessionView">
    ...
    <div class="controls-bar">
      ...
      <button class="ctrl-btn" id="shareBtn" onclick="guest.toggleScreenShare()" title="Share Screen" style="display:none">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
...
const guest = {
  ...
  init() {
    ...
    // Screen sharing is desktop-only: reveal the button when supported
  ...
  async toggleScreenShare() {
    ...
    try {
      ...
      if (err && err.name === 'NotAllowedError') return; // user dismissed the picker
