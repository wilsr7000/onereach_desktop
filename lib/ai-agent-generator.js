 ...
 * structured capability description in the prompt.
 *
...

{
  ...
  "prompt": "A clear system prompt describing what this agent does and what capabilities it has. Focus on WHAT the agent can do, not on example phrases users might say.",
...
- The "prompt" should describe the agent's capabilities clearly so the routing LLM can determine if a user request matches. Do NOT include example phrases, confidence score instructions, or references to other agents.
