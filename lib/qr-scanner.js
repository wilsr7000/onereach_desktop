...
class QRScanner {
  ...
  async scanFromScreen() {
    try {
      console.log('[QRScanner] Starting screen capture for QR scan...');
      ...
      console.log(`[QRScanner] Captured screen: ${imgWidth}x${imgHeight}`);
      ...
      if (qrCode) {
        console.log('[QRScanner] QR code found!');
        return qrCode.data;
      }
      
      console.log('[QRScanner] No QR code found in screen capture');
      return null;
      
    } catch (error) {
      console.error('[QRScanner] Screen scan error:', error.message);
      throw error;
    }
  }
  ...
  async scanFromFile(imagePath) {
    try {
      console.log(`[QRScanner] Scanning image file: ${imagePath}`);
      ...
      if (qrCode) {
        console.log('[QRScanner] QR code found in image!');
        return qrCode.data;
      }
      
      console.log('[QRScanner] No QR code found in image');
      return null;
      
    } catch (error) {
      console.error('[QRScanner] File scan error:', error.message);
      throw error;
    }
  }
  ...
  async scanFromClipboard() {
    try {
      ...
      if (image.isEmpty()) {
        console.log('[QRScanner] No image in clipboard');
        return null;
      }
      ...
      if (qrCode) {
        console.log('[QRScanner] QR code found in clipboard!');
        return qrCode.data;
      }
      
      console.log('[QRScanner] No QR code found in clipboard image');
      return null;
      
    } catch (error) {
      console.error('[QRScanner] Clipboard scan error:', error.message);
      throw error;
    }
  }
