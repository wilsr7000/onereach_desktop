...
// Same Edison account/base every queue surface uses. The /keyvalue
// endpoint takes no credential (see webapp src/neon.js — same wire).
const KV_URL =
  'https://em.edison.api.onereach.ai/http/35254342-4a2e-475b-aec1-18547e517e29/keyvalue';
...
async function kvGet(key) {
  const u = `${KV_URL}?id=${encodeURIComponent(COLLECTION)}&key=${encodeURIComponent(key)}`;
