...
vi.mock('child_process', () => ({
  execFile: vi.fn((cmd, args, opts, cb) => {
    ...
    const stdout = cmd === 'ffprobe' || (Array.isArray(args) && args.includes('-show_streams'))
      ? JSON.stringify({ streams: [{ codec_type: 'audio', channels: 2, bit_rate: '192000' }], format: { duration: '60.0' } })
      : 'mock output';
