...
test.describe('Budget Manager', () => {
  ...
  // ── Project Switching ────────────────────────────────────────────────────
  test('switching projects updates all cards', async () => {
    expect(true).toBe(true);
  });
  test('"Global" view aggregates all project data', async () => {
    expect(true).toBe(true);
  });

  // ── Cost Table ───────────────────────────────────────────────────────────
  test('estimated, actual, variance columns calculate correctly', async () => {
    expect(true).toBe(true);
  });
  test('status column shows correct indicator', async () => {
    expect(true).toBe(true);
  });
  test('totals row sums all categories', async () => {
    expect(true).toBe(true);
  });

  // ── Activity Feed ────────────────────────────────────────────────────────
  test('activity entries show timestamp, provider, cost', async () => {
    expect(true).toBe(true);
  });

  // ── Setup Wizard ─────────────────────────────────────────────────────────
  test('setup wizard summary shows entered values', async () => {
    expect(true).toBe(true);
  });

  // ── Estimator ────────────────────────────────────────────────────────────
  test('auto-detection parses checkboxes and numbers', async () => {
    expect(true).toBe(true);
  });
  test('total cost sums all enabled features correctly', async () => {
    expect(true).toBe(true);
  });
  test('green indicator when estimate < budget', async () => {
    expect(true).toBe(true);
  });
  test('yellow indicator when estimate > 75% of budget', async () => {
    expect(true).toBe(true);
  });
  test('red indicator when estimate > budget', async () => {
    expect(true).toBe(true);
  });
