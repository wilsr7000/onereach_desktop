        ...
        try {
            ...
            const styleGuide = await page.evaluate(() => {
                ...
                const normalizeColor = (color) => {
                    if (!color || color === 'transparent' || color === 'rgba(0, 0, 0, 0)' || color === 'inherit' || color === 'currentcolor') {
                        return null;
                    }
                    return color;
                };
                ...
                // ===== BACKGROUNDS =====
                const bgElements = document.querySelectorAll('header, footer, nav, main, section, article, aside, div[class*="hero"], div[class*="banner"], div[class*="card"], div[class*="container"]');
                ...
                // ===== CARDS & CONTAINERS =====
                const cards = document.querySelectorAll('[class*="card"], [class*="panel"], [class*="box"], [class*="container"]');
                cards.forEach(card => {
                ...
                [...guide.colors.text, ...guide.colors.backgrounds, ...guide.colors.borders, ...guide.colors.accents]
                    .forEach(c => {
                        if (c && c.value) {
            ...
            console.log(`[StyleGuide] Extracted: ${styleGuide.colors.all.length} colors, ${styleGuide.typography.fonts.length} fonts, ${styleGuide.buttons.length} button styles`);
            return styleGuide;
