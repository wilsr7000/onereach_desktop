...
- [x] **Test audit cleanup: deprecated recorder P2P handlers + asset-editing manual items + spaces auto-skip false positives (v5.0.11)**
...
- [x] **Orb Unified UX redesign: dual-channel agent contract, chat-as-log, hybrid inline/modal, voice-in-only TTS, cancel/stop intents, proactive alerts, 5-agent migration (v5.0.11)**
  ...
  - **Fix**: Six-phase redesign shipping as v5.0.11.
