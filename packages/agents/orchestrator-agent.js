...
const COMPOSITE_PATTERNS = [
  {
    name: 'cheer_up',
    patterns: [/cheer me up/i, /feeling (down|sad|blue)/i, /having a (bad|rough|tough) day/i, /need (cheering|some cheer)/i],
    agents: ['smalltalk', 'dj'],
...
This agent ONLY bids when a request clearly requires coordination between multiple agents. For simple single-purpose requests, let the specialized agent handle it directly.`,
  ...
  keywords: [
    'cheer me up', 'feeling down', 'feeling sad', 'bad day', 'rough day',
    'help me relax', 'feeling stressed', 'feeling anxious', 'calm down',
    'help me focus', 'need to concentrate', 'focus mode',
    'need energy', 'pump me up', 'wake me up', 'feeling tired',
