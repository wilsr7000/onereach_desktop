...
const PLAYBOOKS = {
  'first-time-setup': {
    ...
    steps: [
      {
        title: 'Welcome',
        instruction: "Welcome to GSX Power User! Let's get you set up. First, open Settings with Cmd+comma.",
      },
      {
        title: 'Add API Keys',
        instruction:
          'Go to Settings → API Keys. Add your OpenAI key for AI features. You can also add ElevenLabs for voice features.',
      },
      {
        title: 'Create Your First Space',
        instruction:
          'Click the + button in the sidebar to create a Space. Name it something like "My Projects" or "General".',
      },
      {
        title: 'Try the Clipboard',
        instruction:
          'Copy some text from anywhere. Then press Cmd+Shift+V to see your clipboard history. Everything you copy is saved!',
      },
      {
        title: 'Explore AI Agents',
        instruction:
          'Open the AI menu to see ChatGPT, Claude, and other AI tools. Your conversations auto-save to Spaces.',
      },
      {
        title: 'Try Voice Commands',
        instruction: 'Click the orb or hold spacebar, then say "What can you do?" to learn voice commands.',
      },
      {
        title: "You're Ready!",
        instruction:
          'Setup complete! Explore the app and ask me anytime you need help. Say "give me a tour" to learn more about any feature.',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        instruction: 'Go to Window menu → Video Editor, or drag your video file onto the app.',
      },
      {
        title: 'Load Your Video',
        instruction: 'Click "Open Video" or drag your video file into the editor. Wait for it to load with waveform.',
      },
      {
        title: 'Get Transcription',
        instruction: 'Click the "Transcribe" button. This converts the audio to text that the AI voice will speak.',
      },
      {
        title: 'Set Range',
        instruction:
          'Move the playhead to where you want AI voice to start. Press I for in-point. Move to end, press O for out-point.',
      },
      {
        title: 'Replace with AI Voice',
        instruction: 'With your range selected, click "Replace with AI Voice". Choose a voice from the dropdown.',
      },
      {
        title: 'Preview',
        instruction:
          "Play back the section to hear the AI voice. If you don't like it, use undo and try a different voice.",
      },
    ...
    steps: [
      {
        ...
        instruction:
          "Think about how you work. Common spaces: Projects, Reference, Ideas, Archive. We'll create these.",
      },
      {
        title: 'Create Main Spaces',
        instruction:
          'Click + in the sidebar. Create spaces for your main categories. Start with "Active Projects" and "Reference".',
      },
      {
        title: 'Add Content',
        instruction:
          'Drag files, images, or text into your spaces. You can also copy text and use Cmd+Shift+V to save from clipboard.',
      },
      {
        title: 'Use Browser Extension',
        instruction:
          'Install the browser extension from Settings → Extensions. Now you can save web content directly to Spaces.',
      },
      {
        title: 'Search Everything',
        instruction: 'Press Cmd+F to search across all your spaces. The search finds text inside documents too.',
      },
      {
        title: 'Set Up Sync',
        instruction:
          'Go to Settings → Sync to enable GSX cloud sync. Your content will be backed up and available across devices.',
      },
      {
        title: 'Done!',
        instruction:
          'Your organization system is ready! Remember: drag to add, Cmd+F to find, and everything is searchable.',
      },
    ],
  },
  ...
  'build-with-gsx-create': {
    ...
    steps: [
      {
        title: 'Open GSX Create',
        instruction: 'Press Cmd+Shift+G or go to Window → GSX Create to open the coding assistant.',
      },
      {
        title: 'Describe Your Task',
        instruction:
          'Type what you want to build in plain English. Be specific: "Create a Python script that downloads images from URLs in a text file."',
      },
      {
        title: 'Watch the Workflow',
        instruction:
          'GSX Create uses a 7-phase workflow. Watch the progress panel to see what the AI is doing at each step.',
      },
      {
        title: 'Review the Code',
        instruction: 'When complete, review the generated code. The AI explains what it created and why.',
      },
      {
        title: 'Make Changes',
        instruction:
          'Not quite right? Add another task: "Make the script also resize images to 800px width." It builds on previous work.',
      },
      {
        title: 'Monitor Budget',
        instruction:
          'Check the cost display in the top bar. Complex tasks use more tokens. Set a budget limit in Settings if needed.',
      },
      {
        title: 'Export Your Work',
        instruction:
          'Use the Export button to save your code and the AI conversation. Work persists even if you close the app.',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        instruction: 'Go to Agents menu → Create New Agent, or say "Create a new agent" to the voice assistant.',
      },
      {
        title: 'Name Your Agent',
        instruction:
          'Give it a clear name like "Email Helper" or "Meeting Scheduler". This is what you\'ll say to activate it.',
      },
      {
        title: 'Define Keywords',
        instruction:
          'Add keywords that trigger your agent: "email", "send", "compose" for an email agent. Multiple keywords help recognition.',
      },
      {
        title: 'Write the Prompt',
        instruction: 'Describe what your agent does and how it should respond. Be specific about the task and tone.',
      },
      {
        title: 'Choose a Voice',
        instruction:
          'Select a voice personality. Different voices work better for different tasks - "nova" for friendly, "onyx" for professional.',
      },
      {
        title: 'Test It',
        instruction: 'Click Test to try your agent. Speak naturally and see if it responds correctly.',
      },
      {
        title: 'Refine and Save',
        instruction: 'Adjust keywords and prompt based on testing. When satisfied, click Save. Your agent is now live!',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        instruction:
          'Good news - conversations auto-save! Every chat with ChatGPT, Claude, Gemini, Grok, and Perplexity is captured.',
      },
      {
        title: 'Find Your Conversations',
        instruction:
          'Open Spaces. Look for "ChatGPT Conversations", "Claude Conversations", etc. Each AI has its own Space.',
      },
      {
        title: 'Browse History',
        instruction: "Click a conversation Space to see all your chats. They're organized by date and topic.",
      },
      {
        title: 'Search Conversations',
        instruction: 'Use Cmd+F to search. Find that brilliant prompt or answer you had last week.',
      },
      {
        title: 'Organize Further',
        instruction:
          'Drag important conversations to project-specific Spaces. Create a "Best Prompts" Space for your favorites.',
      },
      {
        title: 'Export if Needed',
        instruction: 'Right-click any conversation → Smart Export to get Markdown, PDF, or other formats.',
      },
      {
        title: 'Done!',
        instruction: 'Your AI conversations are automatically saved and searchable. Never lose a good chat again!',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        instruction: 'Go to View menu → Budget Dashboard. This shows all your AI spending.',
      },
      {
        title: 'View Current Spending',
        instruction: 'The dashboard shows today, this week, and this month. See which AI services cost the most.',
      },
      {
        title: 'View by Model',
        instruction: 'Click the "By Model" tab. GPT-4 costs more than GPT-3.5. See where your money goes.',
      },
      {
        title: 'Set a Limit',
        instruction: 'Click "Set Limit" and enter a daily or monthly budget. You\'ll get warnings when approaching it.',
      },
      {
        title: 'Configure Alerts',
        instruction: 'In Settings → Budget, set up alerts at 50%, 75%, and 90% of your limit.',
      },
      {
        title: 'Optimize Usage',
        instruction:
          'For cheaper operations, use GPT-3.5 instead of GPT-4 when possible. GSX Create shows cost per task.',
      },
      {
        title: 'Review Weekly',
        instruction: 'Check the dashboard weekly. Export reports for expense tracking. Stay in control!',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        instruction: 'Press Cmd+Shift+H to open App Health. Look for any red indicators or error counts.',
      },
      {
        title: 'View Recent Errors',
        instruction: 'In App Health → Logs, filter by "Error" to see recent problems. Read the messages for clues.',
      },
      {
        title: 'Try Restarting',
        instruction:
          'Many issues fix with a restart. Quit the app fully (Cmd+Q) and reopen. This clears temporary state.',
      },
      {
        title: 'Check Connectivity',
        instruction: 'AI features need internet. Check your connection. API errors often mean network issues.',
      },
      {
        title: 'Verify API Keys',
        instruction: 'Go to Settings → API Keys. Make sure keys are valid and not expired. Test each one.',
      },
      {
        title: 'Export Logs',
        instruction: 'If problems persist, go to App Health → Logs → Export. This creates a file for support.',
      },
      {
        title: 'Get Help',
        instruction:
          'Help menu → Report Issue attaches logs automatically. Or ask me - say "I\'m having a problem with [feature]".',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        instruction: 'The most important ones: Cmd+Shift+V (clipboard), Cmd+K (quick launcher), Cmd+, (settings).',
      },
      {
        title: 'Navigation',
        instruction: 'Cmd+1 focuses Spaces sidebar. Cmd+2-9 switch between open tabs. Cmd+W closes current tab.',
      },
      {
        title: 'GSX Create',
        instruction: 'Cmd+Shift+G opens GSX Create. Cmd+Enter sends your task. Escape cancels current operation.',
      },
      {
        title: 'Video Editor',
        instruction:
          'Space plays/pauses. I sets in-point. O sets out-point. M creates marker. Left/Right arrows step frames.',
      },
      {
        title: 'Search Everywhere',
        instruction: 'Cmd+F searches in current view. Cmd+Shift+F searches all Spaces. Type immediately to filter.',
      },
      {
        title: 'Quick Launcher',
        instruction:
          'Cmd+K opens the launcher. Type any feature name to jump there instantly. "chatgpt", "video", "settings".',
      },
      {
        title: 'View All Shortcuts',
        instruction: 'Go to Settings → Keyboard Shortcuts for the complete list. You can customize any shortcut there.',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        instruction: 'First, select what you want to export. This can be from Spaces, clipboard, or any editor.',
      },
      {
        title: 'Open Smart Export',
        instruction: 'Right-click the content → Smart Export. Or use Edit menu → Smart Export.',
      },
      {
        title: 'Choose Format',
        instruction:
          'Select your format: Markdown for docs, PDF for sharing, HTML for web. Each has different options.',
      },
      {
        title: 'Apply Style Guide',
        instruction:
          'Want to match a brand? Enter a URL and click "Extract Style Guide". It copies fonts, colors, and formatting.',
      },
      {
        title: 'Use a Template',
        instruction: 'Or choose a saved template from the dropdown. Templates remember your preferred formatting.',
      },
      { title: 'Preview', instruction: "Click Preview to see exactly what you'll get. Make adjustments if needed." },
      {
        title: 'Export',
        instruction: 'Click Export and choose where to save. Your formatted content is ready to share!',
      },
    ],
  },
};
...
{"type": "<intent_type>", "confidence": <0.0-1.0>}`;
   ...
   */
  async _handleGenericQuestion(_task) {
    // Just provide helpful guidance
    return {
      success: true,
      message:
        "I'm the App Guide. I can open any app or tool for you, give tours of features, or run step-by-step tutorials. What would you like to do?",
    };
  },
   ...
   */
  async _answerProductQuestion(product, query, _task) {
  ...
  _handleTourRequest(task) {
    ...
    const productNames = Object.values(APP_PRODUCTS)
      .map((p) => p.name)
      .join(', ');
    return {
      success: true,
  ...
  async _continueTour(tourState, task) {
    ...
    return {
      ...
      needsInput:
        nextStep < tourState.steps.length
          ? {
  ...
  async _continuePlaybook(playbookState, task) {
    ...
    if (input.includes('skip') || input.includes('end') || input.includes('stop') || input.includes('cancel')) {
      return {
        success: true,
        message: `Playbook ended. Feel free to ask me anything or run another playbook anytime!`,
      };
    }
    ...
    return {
      ...
      needsInput:
        nextStep < playbookState.totalSteps
          ? {
  ...
  _listActions(product) {
    ...
    const actionList = product.actions
      .slice(0, 5)
