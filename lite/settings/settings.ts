...
function mountAbout(container: HTMLElement): (() => void) | undefined {
  ...
  intro.textContent =
    'Onereach Desktop is a slim app that ships on its own: it signs you in to Onereach and gives your AIs, Spaces, tutorials, and bug reporting a single home — with everything else loaded on demand or deferred to the full app.';
