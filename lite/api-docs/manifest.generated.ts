  ...
  "modules": [
    {
      ...
      "events": {
        ...
        "entries": [
          ...
          {
            "constantKey": "IPC_KEY_TEST",
            "name": "ai.ipc.key-test",
            "description": ""
          },
          {
    ...
    },
    {
      ...
      "events": {
        ...
        "entries": [
          ...
          {
            "constantKey": "IPC_FETCH_ARTICLE_BODY",
            "name": "ai-run-times.ipc.fetch-article-body",
            "description": ""
          },
          {
          ...
          {
            "constantKey": "IPC_CLEAR_READING_LOG",
            "name": "ai-run-times.ipc.clear-reading-log",
            "description": ""
          },
          {
            "constantKey": "IPC_EXPORT_READING_LOG",
            "name": "ai-run-times.ipc.export-reading-log",
            "description": ""
          },
          {
    ...
    },
    {
      ...
      "events": {
        ...
        "entries": [
          ...
          {
            "constantKey": "WEBAUTHN_ACCOUNT_SELECT",
            "name": "auth.webauthn.account-select",
            "description": ""
          },
          {
          ...
          {
            "constantKey": "OAUTH_POPUP_ALLOWED",
            "name": "auth.oauth-popup.allowed",
            "description": ""
          },
          {
            "constantKey": "OAUTH_POPUP_DENIED",
            "name": "auth.oauth-popup.denied",
            "description": ""
          },
          {
            "constantKey": "OAUTH_POPUP_PARENT_ORIGIN_REACHED",
            "name": "auth.oauth-popup.parent-origin-reached",
            "description": ""
          },
          {
            "constantKey": "OAUTH_POPUP_AUTO_CLOSED",
            "name": "auth.oauth-popup.auto-closed",
            "description": ""
          },
          {
            "constantKey": "OAUTH_POPUP_CRASHED",
            "name": "auth.oauth-popup.crashed",
            "description": ""
          },
          {
            "constantKey": "TOTP_DETECTED",
            "name": "auth.totp.detected",
            "description": ""
          },
          {
            "constantKey": "TOTP_FILLED",
            "name": "auth.totp.filled",
            "description": ""
          },
          {
            "constantKey": "TOTP_FILL_FAILED",
            "name": "auth.totp.fill-failed",
            "description": ""
          },
          {
            "constantKey": "TOTP_NO_SECRET",
            "name": "auth.totp.no-secret",
            "description": ""
          },
          {
            "constantKey": "ACCOUNT_PICKER_DETECTED",
            "name": "auth.account-picker.detected",
            "description": ""
          },
          {
    ...
    },
    {
      ...
      "events": {
        ...
        "entries": [
          ...
          {
            "constantKey": "DRAIN_START",
            "name": "bug-report.drain.start",
            "description": ""
          },
          {
            "constantKey": "DRAIN_FINISH",
            "name": "bug-report.drain.finish",
            "description": ""
          },
          {
            "constantKey": "DRAIN_FAIL",
            "name": "bug-report.drain.fail",
            "description": ""
          },
          {
    ...
    },
    {
      "slug": "calendar",
      "title": "Calendar",
      "summary": "Calendar API (ADR-090) — the account's scheduled flows, read from GSX.\n\nWhat \"scheduled\" means here: a flow whose canvas carries the platform's\n\"Schedule execution\" step. At activation that step registers its\nschedule events (Quartz cron expressions in a time zone, a start and\nan end) with the Event Manager, which fires the flow. The Event\nManager publishes no listing, so the flow definitions — the very data\nthe step hands it — are what this API reads: every bot's flows from\nthe datahub, scanned for the step (`schedule.ts`), expanded into\noccurrences (`cron.ts`).\n\nPublic surface: {@link CalendarApi}. Singleton accessors follow the\nRule-12 module contract (`getCalendarApi` / `configureCalendarApi` /\n`_resetCalendarApiForTesting` / `_setCalendarApiForTesting`).",
      "surface": {
        "interfaceName": "CalendarApi",
        "interfaceDescription": "",
        "methods": [
          {
            "name": "snapshot",
            "signature": "snapshot(opts?: { refresh?: boolean }): Promise<CalendarSnapshot>",
            "description": "Every scheduled flow in the signed-in account (cached; `refresh` re-reads GSX).",
            "tags": [],
            "examples": []
          },
          {
            "name": "occurrences",
            "signature": "occurrences(input: CalendarOccurrencesInput): Promise<CalendarOccurrencesResult>",
            "description": "Scheduled runs within a window, ascending, capped.",
            "tags": [],
            "examples": []
          },
          {
            "name": "status",
            "signature": "status(): CalendarStatus",
            "description": "Signed-in state and cache age, without a network call.",
            "tags": [],
            "examples": []
          },
          {
            "name": "openFlow",
            "signature": "openFlow(input: { flowId: string; botId: string }): Promise<void>",
            "description": "Open the flow in GSX Designer (Lite's signed-in GSX window).",
            "tags": [],
            "examples": []
          },
          {
            "name": "openWindow",
            "signature": "openWindow(): Promise<void>",
          ...
          {
            "name": "setArmed",
            "signature": "setArmed(input: SetArmedInput): Promise<SetArmedResult>",
            "description": "Arm (activate) or disarm (deactivate) a scheduled flow through the deployer; resolves when the platform reports the deploy done.",
            "tags": [],
            "examples": []
          },
          {
            "name": "flowLinks",
            "signature": "flowLinks(input: FlowLinksInput): Promise<FlowLinksResult>",
            "description": "The playbook that built a flow (watcher queue) and the journey maps in reach (sight-filtered).",
            "tags": [],
            "examples": []
          }
        ]
        ...
        "entries": [
          {
            ...
            "name": "calendar.snapshot.start",
            "description": ""
          },
          {
            "constantKey": "SNAPSHOT_FINISH",
            "name": "calendar.snapshot.finish",
            "description": ""
          },
          {
            "constantKey": "SNAPSHOT_FAIL",
            "name": "calendar.snapshot.fail",
            "description": ""
          },
          {
            "constantKey": "OPEN_WINDOW",
            "name": "calendar.open-window",
            "description": ""
          },
          {
          ...
          {
            "constantKey": "SET_ARMED_START",
            "name": "calendar.set-armed.start",
            "description": ""
          },
          {
            "constantKey": "SET_ARMED_FINISH",
            "name": "calendar.set-armed.finish",
            "description": ""
          },
          {
            "constantKey": "SET_ARMED_FAIL",
            "name": "calendar.set-armed.fail",
            "description": ""
          },
          {
            "constantKey": "ARMED",
          ...
          {
            "constantKey": "DISARMED",
            "name": "calendar.disarmed",
            "description": ""
          },
          {
            "constantKey": "FLOW_LINKS_START",
            "name": "calendar.flow-links.start",
            "description": ""
          },
          {
            "constantKey": "FLOW_LINKS_FINISH",
            "name": "calendar.flow-links.finish",
            "description": ""
          },
          {
            "constantKey": "FLOW_LINKS_FAIL",
            "name": "calendar.flow-links.fail",
            "description": ""
          },
          {
            "constantKey": "EXPORT_ICS",
    ...
    },
    {
      ...
      "events": {
        ...
        "entries": [
          ...
          {
            "constantKey": "MENU_OPEN_STUDIO",
            "name": "gsx.menu.open-studio",
            "description": ""
          },
          {
            "constantKey": "MENU_OPEN_LINK",
            "name": "gsx.menu.open-link",
            "description": ""
          },
          {
            "constantKey": "MENU_OPEN_AGENT_LIBRARY",
            "name": "gsx.menu.open-agent-library",
            "description": ""
          },
          {
            "constantKey": "IPC_OPEN_WINDOW",
    ...
    },
    {
      ...
      "events": {
        ...
        "entries": [
          ...
          {
            "constantKey": "CONVERSATION_TAP_START",
            "name": "idw.conversation.tap.start",
            "description": ""
          },
          {
            "constantKey": "CONVERSATION_ARCHIVE_FINISH",
            "name": "idw.conversation.archive.finish",
            "description": ""
          },
          {
            "constantKey": "MEMORY_EXPORT_FINISH",
            "name": "idw.memory.export.finish",
            "description": ""
          },
          {
            "constantKey": "UPDATE_START",
    ...
    },
    {
      ...
      "surface": {
        ...
        "methods": [
          ...
          {
            "name": "markComplete",
            "signature": "markComplete(stepId: OnboardingStepId): Promise<OnboardingState>",
            "description": "Mark a step complete. Idempotent.",
            "tags": [],
            "examples": []
          },
          {
            "name": "dismiss",
            "signature": "dismiss(): Promise<OnboardingState>",
            "description": "User dismissed the card.",
            "tags": [],
            "examples": []
          },
          {
            "name": "onChange",
            "signature": "onChange(listener: (state: OnboardingState) => void): () => void;",
            "description": "Subscribe to state changes. Returns an unsubscribe.",
            "tags": [],
            "examples": []
          }
        ]
      ...
      "surface": {
        ...
        "methods": [
          ...
          },
          {
            ...
            "description": "ADR-088 — the agent's admission checklist (shared KV document, same words and grading as the hosted page).",
            "tags": [],
            "examples": []
          },
          {
    ...
    },
    {
      ...
      "surface": {
        ...
        "methods": [
          ...
          {
            "name": "resolveFileUrl",
            "signature": "resolveFileUrl(key: string): Promise<string | null>",
          ...
          {
            "name": "createAgentFromLibrary",
            "signature": "createAgentFromLibrary(input: CreateAgentFromLibraryInput): Promise<Item>",
            "description": "Add a LIBRARY agent to a Space — the asset `[:REPRESENTS]` the\nexisting `:Agent` (no new agent node); endpoints attach to it.",
            "tags": [],
            "examples": []
          },
          {
    ...
    },
    {
      ...
      "surface": {
        ...
        "methods": [
          {
            "name": "list",
            "signature": "list(): Promise<ToolEntry[]>",
            "description": "All entries, in storage order.",
            "tags": [],
            "examples": []
          },
          {
            "name": "get",
            "signature": "get(id: string): Promise<ToolEntry | null>",
            "description": "Single entry by id, or null if absent.",
            "tags": [],
            "examples": []
          },
          {
            "name": "add",
            "signature": "add(entry: Partial<ToolEntry> & Pick<ToolEntry, 'label' | 'url'>): Promise<ToolEntry>",
            "description": "Add a new entry.",
            "tags": [
              {
                "tag": "throws",
                "value": "{ToolsError} `TOOLS_DUPLICATE` if an explicit `id` collides."
              },
              {
                "tag": "throws",
                "value": "{ToolsError} `TOOLS_INVALID_INPUT` for missing label."
              },
              {
                "tag": "throws",
                "value": "{ToolsError} `TOOLS_INVALID_URL` for non-http/https URLs."
              },
              {
                "tag": "throws",
                "value": "{ToolsError} `TOOLS_PERSISTENCE_FAILED` if KV write rejects."
              }
            ],
            "examples": []
          },
          {
            "name": "update",
            "signature": "update(id: string, patch: Partial<ToolEntry>): Promise<ToolEntry>",
            "description": "Update mutable fields on an existing entry.",
            "tags": [
              {
                "tag": "throws",
                "value": "{ToolsError} `TOOLS_NOT_FOUND` if no entry with `id`."
              },
              {
                "tag": "throws",
                "value": "{ToolsError} `TOOLS_INVALID_URL` for an invalid url."
              },
              {
                "tag": "throws",
                "value": "{ToolsError} `TOOLS_INVALID_INPUT` for an empty label."
              },
              {
                "tag": "throws",
                "value": "{ToolsError} `TOOLS_PERSISTENCE_FAILED` if KV write rejects."
      ...
      "events": {
        ...
        "entries": [
          {
            "constantKey": "ADD_START",
            "name": "tools.add.start",
            "description": ""
          },
          {
            "constantKey": "ADD_FINISH",
            "name": "tools.add.finish",
            "description": ""
          },
          {
            "constantKey": "ADD_FAIL",
          ...
          {
            "constantKey": "UPDATE_START",
            "name": "tools.update.start",
            "description": ""
          },
          {
            "constantKey": "UPDATE_FINISH",
            "name": "tools.update.finish",
            "description": ""
          },
          {
            "constantKey": "UPDATE_FAIL",
            "name": "tools.update.fail",
            "description": ""
          },
          {
            "constantKey": "REMOVE_START",
            "name": "tools.remove.start",
            "description": ""
          },
          {
            "constantKey": "REMOVE_FINISH",
            "name": "tools.remove.finish",
            "description": ""
          },
          {
            "constantKey": "REMOVE_FAIL",
            "name": "tools.remove.fail",
            "description": ""
          },
          {
            "constantKey": "CHANGED",
          ...
          {
            "constantKey": "MANAGE_OPENED",
            "name": "tools.manage.opened",
            "description": ""
          },
          {
          ...
          {
            "constantKey": "IPC_UPDATE",
            "name": "tools.ipc.update",
            "description": ""
          },
          {
            "constantKey": "IPC_REMOVE",
            "name": "tools.ipc.remove",
            "description": ""
          },
          {
            "constantKey": "IPC_OPEN",
          ...
          {
            "constantKey": "IPC_OPEN_MANAGER",
            "name": "tools.ipc.open-manager",
            "description": ""
          }
        ]
      },
