...
export const SPACES_EVENTS = {
  ...
  NEST_START: 'spaces.nest.start',
  NEST_FINISH: 'spaces.nest.finish',
  NEST_FAIL: 'spaces.nest.fail',
  UNNEST_START: 'spaces.unnest.start',
  UNNEST_FINISH: 'spaces.unnest.finish',
  UNNEST_FAIL: 'spaces.unnest.fail',
  NEST_INHERITANCE_START: 'spaces.nestInheritance.start',
  NEST_INHERITANCE_FINISH: 'spaces.nestInheritance.finish',
  NEST_INHERITANCE_FAIL: 'spaces.nestInheritance.fail',
  LIST_CHILDREN_START: 'spaces.listChildren.start',
  LIST_CHILDREN_FINISH: 'spaces.listChildren.finish',
  LIST_CHILDREN_FAIL: 'spaces.listChildren.fail',
  LIST_PARENTS_START: 'spaces.listParents.start',
  LIST_PARENTS_FINISH: 'spaces.listParents.finish',
  LIST_PARENTS_FAIL: 'spaces.listParents.fail',
