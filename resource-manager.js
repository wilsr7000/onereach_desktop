...
class ResourceManager {
   ...
   */
  handleHighMemory(totalMemory, _processes) {
    ...
    try {
      ...
      if (reason === 'critical') {
        ...
        `
          ...
          .catch((err) => console.warn('[resource-manager] throttle executeJavaScript:', err.message));
      }
  ...
  unthrottleWindow(win) {
    ...
    try {
      ...
      `
        ...
        .catch((err) => console.warn('[resource-manager] unthrottle executeJavaScript:', err.message));
